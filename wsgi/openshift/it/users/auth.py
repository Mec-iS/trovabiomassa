...
def subscription(request):
    if request.method == 'GET':
        ...
        return render_to_response('it/users/register.html', params,
...
def newsletter(request):
    if request.method == 'POST':
        ...
        return render_to_response('it/users/register.html', msg,
                              context_instance=RequestContext(request))
...
def login_user(request):
    ...
    return render_to_response('it/users/login.html', params,
                              context_instance=RequestContext(request))
...
def main_profile(request):
    ...
    return render_to_response('it/users/profile.html', params,
                              context_instance=RequestContext(request))
...
def remove_product(request, product_id):
    if request.method == 'GET':
        ...
        if current_user == removing.reseller.owner_of_account:
            params = {'p': removing}
            return render_to_response('it/users/remove_product.html', params,
                              context_instance=RequestContext(request))
        raise Http404
...
def modify_product(request, product_id, reseller_id):
    ...
    if request.method == 'GET':
        ...
        if current_user == obj.reseller.owner_of_account:
            params['p'] = obj
            return render_to_response('users/modify_product.html', params,
                              context_instance=RequestContext(request))
        raise Http404
    ...
    if request.method == 'POST':
        ...
        if form.is_valid():
            ...
            params.update(csrf(request))
            params['p'] = obj
            return render_to_response('it/users/modify_product.html', params,
                              context_instance=RequestContext(request))
