...
def home(request):
    ...
    return render_to_response('it/home/home.html', params,
...
def find(request, product=None, region= None, province=None):
    ...
    return render_to_response('it/find/biomassa.html', params,
                              context_instance=RequestContext(request))
...
def results(request, product=None, region= None, province=None):
    if request.method == 'GET':
        ...
        return render_to_response('it/results/trovabiomassa.html', params,
                              context_instance=RequestContext(request))
...
def bioshow(request, company, id, product):
    ...
    return render_to_response('it/results/bioshow.html', params,
                              context_instance=RequestContext(request))

@ensure_csrf_cookie    
def coordinates(request):
    return render_to_response('it/coords.html',
                              context_instance=RequestContext(request))
